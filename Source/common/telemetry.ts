...
export function sendTensorboardEntrypointTriggered(
	...
	publicLog2<
		TensorboardEntrypontTriggeredData,
		TensorboardEntrypontTriggeredDataClassification
...
export function sendTensorboardPromptSelection(
	...
	publicLog2<
		TensorboardSelectionData,
		TensorboardSelectionDataClassification
...
export function sendTensorboardLaunch(
	...
	publicLog2<TensorboardLaunchData, TensorboardLaunchDataClassification>(
...
export function sendJumptToSourceNotFound() {
	publicLog2<
		...
		JumptToSourceSourceNotFoundDataClassification
...
export function sendTensorboardDetectedInTerminal() {
	publicLog2<
		...
		TensorboardDetectedInTerminalDataClassification
	>(EventName.TENSORBOARD_JUMP_TO_SOURCE_FILE_NOT_FOUND);
}
...
export function trackInstallOfExtension() {
	publicLog2<TensorboardUsage, TensorboardUsageClassification>(
		"activated",
		{},
	);
}
