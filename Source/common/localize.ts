...
export namespace Localized {
	...
	export const launchNativeTensorBoardSessionCodeLens = l10n.t(
...
export namespace TensorBoard {
	...
	export const useCurrentWorkingDirectory = l10n.t(
		"Use current working directory",
	);

	export const logDirectoryPrompt = l10n.t(
